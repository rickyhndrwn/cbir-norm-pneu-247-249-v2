...
def init_db_values_func():
    ...
    global db_model_dict, db_feature_dict, db_img_paths, db_test_image_paths
...
def index():
    ...
    if request.method == 'POST':
        ...
        # Get key with best result and other result
        best_result_key = max(relevant_img_count_dict, key=relevant_img_count_dict.get)
        other_result_dict = {key: relevant_img_count_dict[key] for key in relevant_img_count_dict.keys() if key != best_result_key}
        ...
        return render_template('index.html',
                               ...
                               other_result_dict=other_result_dict)
